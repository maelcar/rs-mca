...
| V3 | For `p=17,n=16,k=8`, 9-subset sums have distribution `672/673`. | `python experimental/q17_locator_mca/verify_q17_locator_mca.py` | PROVED exact exhaustive scan. |
...
Run from the repository root. Replace `python` with the local bundled Python
...
python experimental/q17_locator_mca/verify_q17_locator_mca.py
```
...
- `q17_locator_mca/verify_q17_locator_mca.py` contains the V3 distribution as
